...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(AdminMiddleware::class)->group(function () {
        ...
        Route::prefix('/evento/{evento_id}')->group(function(){
            ...
            Route::get('/certificados/organizadores', [AdminController::class, "generarCertificadosOrganizadores"])->name('generar-organizadores');
            Route::get('/certificados/ponentes', [AdminController::class, "generarCertificadosPonentes"])->name('generar-ponentes');
